...
urlpatterns = [
    ...
    path('<int:pk>/item/update', views.ItemUpdateView.as_view(), name='item_update'),
    ...
    path('<int:pk>/container/update', views.ContainerUpdateView.as_view(), name='container_update'),
]