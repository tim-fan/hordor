...
urlpatterns = [
    ...
    path('photo/<int:photo_pk>/set_main', views.set_main_photo_view, name='set_main_photo'),
    path('photo/<int:photo_pk>/delete', views.delete_photo_view, name='delete_photo'),
    path('photo/<int:photo_pk>/rotate', views.rotate_photo_view, name='rotate_photo'),
    ...
    path('<int:pk>/container/photos/add', views.add_container_photos_view, name='add_container_photos'),
]